...
public class Drive extends CommandBase {
    ...
    public Drive(SwerveSubsystem dt, double xMeters, double yMeters) {
        this.dt = dt;
    ...
    public void initialize() {
        ...
        Translation2d curPose = dt.currentTranslation();
    ...
    public void execute() {
        ...
        dt.drive(new Translation2d(xSpeed, ySpeed), speeds.omegaRadiansPerSecond, true, true);
    }
    ...
    public void end(boolean interrupted) {
        ...
        // dt.setPoseOdometry(new Pose2d(targetPose.getX(), targetPose.getY(),
