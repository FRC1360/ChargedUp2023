...
public class CubeHighAndBalanceAuto extends SequentialCommandGroup {
    ...
    public CubeHighAndBalanceAuto(SwerveSubsystem dt, ShoulderSubsystem shoulder,
        ...
        addCommands(
                new CubeScoreHighAuto(dt, shoulder, shoulderWristMessenger, wrist, arm, intake, armMessenger,
                        ledSubsystem, sm),
