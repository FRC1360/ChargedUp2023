...
public class AutoBalanceCommand extends CommandBase {
    ...
    public AutoBalanceCommand(SwerveSubsystem dt) {
        this.dt = dt;
    ...
    public void execute() {
        ...
        dt.drive(new Translation2d(xSpeed, this.speeds.vyMetersPerSecond), 0, true, true);
    }

    @Override
    public void end(boolean interrupted) {
        this.speeds.omegaRadiansPerSecond = 0.0001;
        dt.drive(new Translation2d(speeds.vxMetersPerSecond, speeds.vyMetersPerSecond), 0, true, true);
    }
