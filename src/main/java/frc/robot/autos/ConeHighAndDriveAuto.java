...
public class ConeHighAndDriveAuto extends SequentialCommandGroup {
    ...
    public ConeHighAndDriveAuto(SwerveSubsystem dt, ShoulderSubsystem shoulder,
        ...
        addCommands(
                new ConeScoreHighAuto(dt, shoulder, shoulderWristMessenger, wrist, arm, intake, armMessenger,
                        ledSubsystem, sm),
