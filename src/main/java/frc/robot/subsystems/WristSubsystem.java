...
public class WristSubsystem extends SubsystemBase {
    ...
    public WristSubsystem(ShoulderWristMessenger shoulderWristMessenger, DoubleSupplier manualOffset,
            BooleanSupplier manualOffsetEnable) {
    ...
    public void resetMotorRotations() {
        double newPos = (this.absoluteEncoder.getAbsolutePosition() - Constants.WRIST_ENCODER_OFFSET)
    ...
    // Returns the wrist GLOBAL angle. The global angle is the angle relative to the
    // shoulder
    ...
    public double getTargetAngle() { // Use getTargetAngle() when doing commands to move the wrist
        ...
        return -this.shoulderWristMessenger.getShoulderAngle() + this.getWristOffset()
                + (manualOffsetEnable.getAsBoolean() ? -manualOffset.getAsDouble() : 0.0);
    }
    ...
    // relative to wrist starting position.
    // This angle ensures the wrist doesn't move relative to the starting location
    // while the shoulder rotates
    // For example, if the wrist starts pointing directly up and the wrist offset is
    // 0, the wrist will stay pointing up
    ...
    // Getting the cache offset gets the angle that the wrist was at when it was
    // last set
    ...
    public void updateSmartDashboard() {
        // SmartDashboard.putNumber("Wrist_Hold_P_Gain",
        // this.holdPIDController.getPTerm());
        // SmartDashboard.putNumber("Wrist_Hold_I_Gain",
        // this.holdPIDController.getITerm());
        // SmartDashboard.putNumber("Wrist_Hold_D_Gain",
        // this.holdPIDController.getDTerm());

        // SmartDashboard.putNumber("Wrist_Move_P_Gain",
        // this.movePIDController.getPTerm());
        // SmartDashboard.putNumber("Wrist_Move_I_Gain",
        // this.movePIDController.getITerm());
        // SmartDashboard.putNumber("Wrist_Move_D_Gain",
        ...
        // SmartDashboard.putNumber("Wrist_Manual_Offset",
