...
public class ArmSubsystem extends SubsystemBase {
    ...
    public double encoderToDistanceConversion(double encoderPosition) {
        return encoderPosition * Constants.ARM_GEAR_RATIO * Math.PI * Constants.ARM_DRUM_DIAMETER
                * Constants.ARM_PULLEY_BLOCK_RATIO;
    }
    ...
    public double getTargetDistance() {
         ...
         * 
         * if(this.targetDistance + manualOffsetDistance < 0.0) { // If manual offset is
         * negative (retracting) and the new target distance < 0.0
        ...
        /*
         * return this.targetDistance
         * + (this.manualOffsetEnable.getAsBoolean() ? manualOffset.getAsDouble() :
         * 0.0);
         */
    }
    ...
    public void updateSmartDashboard() {
        // SmartDashboard.putNumber("Arm_Hold_P_Gain",
        // this.holdPIDController.getPTerm());
        // SmartDashboard.putNumber("Arm_Hold_I_Gain",
        // this.holdPIDController.getITerm());
        // SmartDashboard.putNumber("Arm_Hold_D_Gain",
        ...
        // SmartDashboard.putNumber("Arm_Move_P_Gain",
        // this.movePIDController.getPTerm());
        // SmartDashboard.putNumber("Arm_Move_I_Gain",
        // this.movePIDController.getITerm());
        // SmartDashboard.putNumber("Arm_Move_D_Gain",
