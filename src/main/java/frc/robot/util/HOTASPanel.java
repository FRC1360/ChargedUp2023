...
public class HOTASController extends GenericHID {
    private static final int L_ROLL_IN = 1;
    private static final int L_ROLL_FORWARD_CW = 2;
    private static final int L_ROLL_FORWARD_CCW = 3;

    private static final int L_PRESS = 4;

    private static final int L_TOGGLE_PRESS = 5;
    private static final int L_TOGGLE_FORWARD = 6;
    private static final int L_TOGGLE_BACKWARD = 7;

    private static final int R_ROLL_IN = 1;
