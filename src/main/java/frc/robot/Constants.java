...
public final class Constants {
    ...
    public static final int TICKS_PER_ANGLE_PIVOT = 1; // EDIT THIS TO THE ENCODER TICKS PER DEGREE
    public static final int TICKS_PER_DISTANCE_CM = 1; // EDIT THIS TO THE ENCODER TICKS PER DISTANCE
}
