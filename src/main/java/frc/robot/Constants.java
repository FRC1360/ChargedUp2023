...
public final class Constants {
    ...
    public static final double SWERVE_DRIVE_MOTOR_RAMP_RATE = 0.001; // Time is seconds for acceleration from 0 to full speed
    public static final double SWERVE_STEER_MOTOR_RAMP_RATE = 0.001; 
